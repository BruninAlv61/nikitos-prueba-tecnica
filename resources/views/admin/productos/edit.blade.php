    ...
    <div class="form-card">
        <form action="{{ route('admin.productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="producto_nombre" type="text" name="nombre" value="{{ old('nombre', $producto->nombre) }}" maxlength="255" required autocomplete="off">
                @error('nombre')<span class="form-error" role="alert">{{ $message }}</span>@enderror
            </div>
            <div class="form-group">
                <label for="producto_codigo">Código</label>
                <input id="producto_codigo" type="text" name="codigo" value="{{ old('codigo', $producto->codigo) }}" maxlength="50" required autocomplete="off">
                @error('codigo')<span class="form-error" role="alert">{{ $message }}</span>@enderror
            </div>
            <div class="form-group">
                <label for="producto_tamaño">Tamaño</label>
                <input id="producto_tamaño" type="text" name="tamaño" value="{{ old('tamaño', $producto->tamaño) }}" maxlength="100" autocomplete="off">
                @error('tamaño')<span class="form-error" role="alert">{{ $message }}</span>@enderror
            </div>
            <div class="form-group">
                <label for="producto_vida_util">Vida útil</label>
                <input id="producto_vida_util" type="text" name="vida_util" value="{{ old('vida_util', $producto->vida_util) }}" maxlength="100" autocomplete="off">
            ...
            <div class="form-group">
                ...
                @if($producto->imagen)
                    <img src="{{ asset('storage/' . $producto->imagen) }}" class="thumb" style="margin-bottom: 8px;" alt=""><br>
                @endif
                <label for="producto_imagen">Nueva imagen</label>
            ...
            <div class="form-group">
                ...
                <label>
                    <input type="checkbox" name="destacado" value="1" @checked(old('destacado', $producto->destacado))>
                    Producto destacado
                </label>
